											...
											<div class="row">
													...
													<div class="single-tab-select-box">
														...
														<div class="travel-select-icon">
															<select class="form-control ">
																...
																<option value="default">출발지를 선택하세요.</option><!-- /.option-->
												...
												<div class="col-sm-3">
													<div class="single-tab-select-box">
														...
														<div class="travel-check-icon">
															<form action="#">
																<input type="text" name="departure" class="form-control" data-toggle="datepicker" placeholder="2018/08/00">
															</form>
												...
												<div class="col-sm-3">
													<div class="single-tab-select-box">
														...
														<div class="travel-check-icon">
															<form action="#">
																<input type="text" name="return" class="form-control" data-toggle="datepicker" placeholder="2018/00/00">
															</form>
														</div><!-- /.travel-check-icon -->
													</div><!--/.single-tab-select-box-->
												</div><!--/.col-->
													...
													<p>깃허브 되냐??</p>
														...
														<div class="travel-select-icon">
															<select class="form-control ">
																...
																<option value="default">인원을 선택하세요.</option><!-- /.option-->
												...
												<div class="single-tab-select-box">
													...
													<div class="travel-select-icon">
														<select class="form-control ">
														  	...
														  	<option value="default">도시를 선택하세요.</option><!-- /.option-->
													...
													<div class="travel-select-icon">
														<select class="form-control ">
														  	...
														  	<option value="default">지역을 선택하세요.</option><!-- /.option-->
